  ...
  return (
    <div className=" flex flex-col w-full p-[10px] bg-zinc-800/50 rounded-lg border border-zinc-500/50">
      <div className="flex gap-5">
        <div className="flex flex-col w-[300px] gap-5 pt-[20px]">
          <img
            src={data.info.poster}
            alt=""
            className=" w-full h-[300px] object-cover rounded-lg"
          />
          <h1 className="bg-cyan-600 border border-zinc-500/50 p-[10px] rounded-lg text-center">{data.moreInfo.synonyms || data.moreInfo.japanese}</h1>
        </div>
